#!/usr/bin/env python3
"""
Teleop para Puzzlebot.
Publica /cmd_vel (Twist, BEST_EFFORT) — lo que puzzlebot_serial_node espera.

Teclas:
  i = adelante        , = atrás
  j = girar izquierda l = girar derecha
  u / o = diagonal    k / espacio = STOP
  q / z = velocidad+/-    e / c = giro+/-
  CTRL-C = salir
"""
import sys
import tty
...
# Corrección de desbalance de motores: si el robot gira a la derecha al ir recto,
# sube este valor. Si gira a la izquierda, ponlo negativo. Rango típico: 0.0 – 0.5
WHEEL_BIAS = 0.80   # rad/s de corrección por cada m/s de velocidad forward
